---
name: python-dev-reference
description: 'Full Python development tool reference — python_check usage, auto-checking hook configuration, CLI commands, pyproject.toml options, and best practices'
version: 1.0.0
---
